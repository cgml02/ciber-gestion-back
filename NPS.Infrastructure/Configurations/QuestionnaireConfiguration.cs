...
public class QuestionnaireConfiguration : IEntityTypeConfiguration<QuestionnaireEntity>
{
    public void Configure(EntityTypeBuilder<QuestionnaireEntity> builder)
    {
        ...
        QuestionnaireEntity[] brandSeedDatas = {
               new("NPS", "¿Cuán probable es que recomiende el producto o servicio a un familiar o amigo? Para ello se les pide calificar en una escala de 0 a 10, donde 0 es «Muy improbable» y 10 es «Definitivamente lo recomendaría»", new DateTime(2024, 01, 01)),
          };
